...
const APP_SHELL_URLS = [
  ...
  '/POS/favicon.ico',
  '/POS/css/style.css',
  '/POS/css/style.css?v=3.1.4-account-continuity',
  '/POS/js/services/operational-access.js',
  '/POS/js/services/operational-access.js?v=3.1.4-account-continuity',
  '/POS/js/main.js',
  '/POS/js/main.js?v=3.1.4-account-continuity',
  '/POS/js/components/dashboard.js',
  '/POS/js/components/dashboard.js?v=3.1.4-account-continuity',
  '/POS/js/components/tables.js',
  '/POS/js/components/tables.js?v=3.1.4-account-continuity',
  '/POS/js/components/menu.js',
  '/POS/js/components/menu.js?v=3.1.4-account-continuity',
  '/POS/js/components/orders.js',
  '/POS/js/components/orders.js?v=3.1.4-account-continuity',
  '/POS/js/components/accounts.js',
  '/POS/js/components/accounts.js?v=3.1.4-account-continuity',
  '/POS/js/components/cash.js',
  '/POS/js/components/cash.js?v=3.1.4-account-continuity',
  '/POS/js/components/users.js',
  '/POS/js/components/users.js?v=3.1.4-account-continuity',
  '/POS/js/components/settings.js',
  '/POS/js/components/settings.js?v=3.1.4-account-continuity',
