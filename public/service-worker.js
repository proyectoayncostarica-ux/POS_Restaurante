const MUNDIPOS_SW_VERSION = 'v2.2.4.9-fix2-role-change-endpoint';
...
const APP_SHELL_URLS = [
  ...
  '/POS/favicon.ico',
  '/POS/css/style.css',
  '/POS/css/style.css?v=2.2.4.9-fix2-role-change-endpoint',
  '/POS/js/main.js',
  '/POS/js/main.js?v=2.2.4.9-fix2-role-change-endpoint',
