const MUNDIPOS_SW_VERSION = 'v2.2.5M.12-template-import';
...
const APP_SHELL_URLS = [
  ...
  '/POS/favicon.ico',
  '/POS/css/style.css',
  '/POS/css/style.css?v=2.2.5M.12-template-import',
  '/POS/js/main.js',
  '/POS/js/main.js?v=2.2.5M.12-template-import',
  '/POS/js/components/dashboard.js',
  '/POS/js/components/dashboard.js?v=2.2.5M.12-template-import',
  '/POS/js/components/tables.js',
  '/POS/js/components/tables.js?v=2.2.5M.12-template-import',
  '/POS/js/components/menu.js',
  '/POS/js/components/menu.js?v=2.2.5M.12-template-import',
  '/POS/js/components/orders.js',
  '/POS/js/components/orders.js?v=2.2.5M.12-template-import',
  '/POS/js/components/accounts.js',
  '/POS/js/components/accounts.js?v=2.2.5M.12-template-import',
  '/POS/js/components/users.js',
  '/POS/js/components/users.js?v=2.2.5M.12-template-import',
  '/POS/js/components/settings.js',
  '/POS/js/components/settings.js?v=2.2.5M.12-template-import',
