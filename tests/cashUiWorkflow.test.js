...
test('PWA conserva Caja dentro del caché vigente de v3.3.1', () => {
    assert.match(serviceWorkerSource, /v3\.3\.1-kitchen-traceability/);
    assert.match(serviceWorkerSource, /components\/cash\.js\?v=3\.3\.1-kitchen-traceability/);
});
