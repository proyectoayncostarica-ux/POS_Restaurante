...
test('PWA conserva Caja dentro del caché vigente de v3.3.0', () => {
    assert.match(serviceWorkerSource, /v3\.3\.0-kitchen-domain/);
    assert.match(serviceWorkerSource, /components\/cash\.js\?v=3\.3\.0-kitchen-domain/);
});
